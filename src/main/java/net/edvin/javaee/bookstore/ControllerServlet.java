package net.edvin.javaee.bookstore;
...
public class ControllerServlet extends HttpServlet {
	 ...
	 public void init() {
			...
			if (jdbcURL == null || jdbcURL.isEmpty() || jdbcUsername == null || jdbcUsername.isEmpty()) {
				throw new IllegalStateException("Database connection parameters are not set properly.");
			}
	    ...
	    private void showNewForm(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
	        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/BookForm.jsp");
	        dispatcher.forward(request, response);
	    }
